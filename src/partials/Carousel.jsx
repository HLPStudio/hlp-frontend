				...
				<div
					...
					<div
						...
						<div className="absolute w-[80%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center">
							<h1 className="h1 mb-4">Welcome to HLP Studio</h1>
							<p className="text-2xl md:text-3xl lg:text-4xl">We are very happy to welcome you on board with HLP Studio.</p>
						</div>
					</div>
					...
					<div
						...
						<div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full bg-gradient-to-b from-transparent via-black to-transparent opacity-30"></div>
						<div className="absolute w-[80%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center">
							<h1 className="h1 mb-4">Make your dreams 3D</h1>
							<p className="text-2xl md:text-3xl lg:text-4xl">We provides top quality architecture design, interior/exterior, and so on.</p>
						</div>
					</div>
					...
					<div
						...
						<div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full bg-gradient-to-b from-transparent via-black to-transparent opacity-30"></div>
						<div className="absolute w-[80%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center">
							<h1 className="h1 mb-4">Bring your ideas to life</h1>
							<p className="text-2xl md:text-3xl lg:text-4xl">We are very happy to welcome you on board with HLP Studio</p>
						</div>
					</div>
				</div>
